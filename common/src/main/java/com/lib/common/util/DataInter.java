...
public class DataInter {
    ...
    public class KEY {
        ...
        public static final String INVATATION_CODE = "invitation_code";
        ...
        public static final String DO_SHARE = "do_share";
        ...
        public static final String USER_PRIVILEGE_INFO = "user.privilege.info";
        public static final String ICON_INDEX = "icon.index";
        public static final String ACTION_REFRESH_ICON = "refresh.icon";
        public static final String WEB_URL = "web_url";
        public static final String PLAY_CODEC = "new_media_code";
        public static final String INPUTED_INVITATION_COED = "inputed_invitation_code";
    }
