package com.jit.funchemistry.ui.custom;
...
public class ChangeClarityDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        mLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.jit.funchemistry.ui.custom.ChangeClarityDialog.this.dismiss();
            }
        });
    ...
    public void setClarityGrade(List<String> items, int defaultChecked) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            params.topMargin = (i == 0) ? 0 : PUtil.dip2px(getContext(), 22f);
