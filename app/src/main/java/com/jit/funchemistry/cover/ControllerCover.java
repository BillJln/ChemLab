...
import com.jit.funchemistry.anylayer.AnimatorHelper;
import com.jit.funchemistry.anylayer.AnyLayer;
import com.jit.funchemistry.anylayer.DialogLayer;
import com.jit.funchemistry.base.GlobalDATA;
import com.jit.funchemistry.model.vo.VideoPlayVo;
import com.jit.funchemistry.receiver.BatteryReceiver;
import com.jit.funchemistry.ui.adapter.PlayListControlAdapter;
import com.jit.funchemistry.ui.custom.ChangeClarityDialog;
import com.jit.funchemistry.utils.StringUtils;
...
import static com.jit.funchemistry.cover.DataInter.Key.KEY_CHOSE_SERI_ENABLE;
import static com.jit.funchemistry.cover.DataInter.Key.KEY_COMPLETE_SHOW;
import static com.jit.funchemistry.cover.DataInter.Key.KEY_CONTROLLER_TOP_ENABLE;
import static com.jit.funchemistry.cover.DataInter.Key.KEY_CURRENTPLAY_INDEX;
import static com.jit.funchemistry.cover.DataInter.Key.KEY_DATA_SOURCE;
import static com.jit.funchemistry.cover.DataInter.Key.KEY_IS_LANDSCAPE;
import static com.jit.funchemistry.cover.DataInter.Key.KEY_TIMER_UPDATE_ENABLE;
import static com.jit.funchemistry.cover.DataInter.Key.KEY_WINDOW_MODE;
...
public class ControllerCover extends BaseCover implements OnTimerUpdateListener, OnTouchGestureListener, View.OnClickListener {
    ...
    public void onReceiverBind() {
        ...
        dlanCast = view.findViewById(R.id.dlan_cast);
        ...
        dlanCast.setOnClickListener(this);
    ...
    protected void onCoverAttachedToWindow() {
        ...
        if (videoPlayVo != null && videoPlayVo.getSeriUrls()!= null && videoPlayVo.getSeriUrls().size()>1){
    ...
    private IReceiverGroup.OnGroupValueUpdateListener mOnGroupValueUpdateListener =
            new IReceiverGroup.OnGroupValueUpdateListener() {
                ...
                public void onValueUpdate(String key, Object value) {
                    ...
                    } else if (key.equals(DataInter.Key.KEY_WINDOW_MODE)) {
                    ...
                    } else if (key.equals(DataInter.Key.KEY_CURRENTPLAY_INDEX)) {
                        int index = getGroupValue().getInt(DataInter.Key.KEY_CURRENTPLAY_INDEX);
                        //索引更新，更新标题
                        setTitle(title + " 第" + (index + 1) + "集");
                        //如果是最后一集，不再显示下一集按钮
                        if (videoPlayVo != null && videoPlayVo.getSeriUrls() != null && index == videoPlayVo.getSeriUrls().size() - 1) {
    ...
    private void setTitle(final String text) {
        mTopTitle.post(new Runnable() {
            @Override
            public void run() {
                mTopTitle.setText(StringUtils.selectTraditionalOrSimplified(text));
                GlobalDATA.PLAY_INDEX = getGroupValue().getInt(KEY_CURRENTPLAY_INDEX);
            }
        });
...
//    }
                ...
                if (currentUrl.equals(videoPlayVo.getSeriUrls().get(i))) {
                    ...
                    mTopTitle.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            getGroupValue().putString(DataInter.Key.KEY_CURRENTPLAY_TITLE, title);
    ...
    private void showChoseListWindow() {
        ...
        final DialogLayer anyLayer = AnyLayer.dialog(getContext())
                .contentView(R.layout.play_list_choose_window_layout)
        ...
        PlayListControlAdapter adapter = new PlayListControlAdapter(videoPlayVo, getContext(), new OnItemClickedListener() {
            @Override
